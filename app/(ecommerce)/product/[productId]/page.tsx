    ...
    return (
        <div className='min-h-screen bg-gray-900 text-gray-100'>
            <main className='container mx-auto px-4 py-8'>
                <motion.button className='mb-8 flex items-center text-[#00FFFF] hover:text-[#00CCCC] transition-colors duration-300'
                    onClick={() => router.back()}
                ...
                >
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='flex items-center space-x-2'>
                            <div className='flex'>
                                {[...Array(5)].map((_, i) => (
                                    <Star
                                        key={i}
                                        className={`h-5 w-5 ${i < Math.floor(4.5) ? "text-yellow-400" : "text-gray-400"}`}
                        ...
                        <div className='flex space-x-4'>
                            ...
                            <Button
                                className='text-[#00FFFF] border-[#00FFFF] hover:bg-[#00CCCC] hover:text-gray-900'
                            >
