            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        ...
                        <p className="text-gray-400 text-base">
                            Bringing the future to your doorstep. Experience the best products
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    {["Smart Home", "Wearables", "Audio", "Computer"].map(
                                        (item) => (
                                            <motion.li key={item} whileHover={{ x: 2 }}>
                                                <a href="#" className="text-base text-gray-400 hover:text-[#00FFFF]">
                                                    {item}
                                                </a>
                                            </motion.li>
                                        )
                ...
                <div className="mt-12 border-t border-gray-800 pt-8">
                    <p className="text-base text-gray-400 xl:text-center">
                        &copy; 2025 OneStore, Inc. All right reserved.
                    </p>
                </div>
            </div>
        </motion.footer>
